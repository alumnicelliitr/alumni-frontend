  ...
  render() {
    return (
      <div className="navbar">
        <Link to="/"><img src="/images/favicon.png" className="navbar-image"/></Link>
        <div className="navbar-container">
          ...
          {!isUserAuthenticated() ? (
            ...
            <Link to="/user/dashboard"><img src={this.props.user.image || '/images/grey.jpg'} className="profile-image-icon" onError={(e) => e.target.src = '/images/grey.jpg'}/></Link>
            </div>
          )}
        </div>
      </div>
