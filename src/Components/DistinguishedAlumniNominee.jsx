    ...
    return (
      <div>
        <div>
          ...
          />
          <textarea
            placeholder="Category of Nomination"
            className="browser-default"
            type="text"
            rows="7"
          ...
          <textarea
            ...
            required
            value={this.props.nominee.nominee_description}
            onChange={this.props.handleChange}
          />
          <input
          ...
          <input
            ...
            onChange={this.props.handleChange}
          />
          <div className="nominee-uploads">
            <div>
              <label className="large-label">Recent Photograph (Preferred File Types : jpg,png):</label><br />
              <input onChange={this.props.handleImage} name="nominee_photo" type="file" alt="photo" required />
            </div>
            <div>
              <label className="large-label">Resume of the nominee (Preferred File Types : pdf,docx):</label><br />
